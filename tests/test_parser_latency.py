"""
Parser Accuracy Evaluation (Precision / Recall / F1)

No external dependencies.
Paper-ready evaluation for UD-style datasets.
"""
...
# =========================
# MINI TEST DATASET (replace with UD later)
# =========================
TEST_SET = [
    (
        "今日は天気がいい",
